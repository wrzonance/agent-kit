...
# shellcheck source=guard-curriculum.sh
source "$GUARD_LIB_DIR/guard-curriculum.sh"
...
# shellcheck source=guard-command-segments.sh
source "$GUARD_LIB_DIR/guard-command-segments.sh"
