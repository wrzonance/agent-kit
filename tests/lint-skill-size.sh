...
declare -A KNOWN_OVERSIZE=(
    ...
    # #902: overlap immutable snapshot review with CI and gate final-head publication.
    [review-remote-pr]="527:9540:450"
    ...
    # #902: keep review launch eligibility separate from live CI state.
    [parallel-issues]="778:16773:500"
)
