...
assert_eq yes "$([[ $(wc -l < "$root/agentkit/skills/.shared/scripts/agent-preflight.sh") -le 1400 ]] && printf yes || printf no)" \
    'agent-preflight.sh stays at or under 1400 lines (including harness-bound runtime-tool metadata)'
