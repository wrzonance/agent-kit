...
assert_eq yes "$([[ $(wc -l < "$root/agentkit/skills/.shared/scripts/agent-run.sh") -le 2112 ]] && printf yes || printf no)" \
    'agent-run.sh stays at or under 2112 lines (#905 native evidence lease repair)'
