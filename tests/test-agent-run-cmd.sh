...
assert_eq yes "$([[ $(wc -l < "$root/agentkit/skills/.shared/scripts/agent-run.sh") -le 2008 ]] && printf yes || printf no)" \
    'agent-run.sh stays at or under 2008 lines (#873 metadata + #874 lifecycle)'
