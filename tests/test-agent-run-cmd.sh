...
assert_eq yes "$([[ $(wc -l < "$root/agentkit/skills/.shared/scripts/agent-run.sh") -le 2094 ]] && printf yes || printf no)" \
    'agent-run.sh stays at or under 2094 lines (#905 native execution records)'
