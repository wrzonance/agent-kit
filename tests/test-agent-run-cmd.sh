...
assert_eq yes "$([[ $(wc -l < "$root/agentkit/skills/.shared/scripts/agent-run.sh") -le 1800 ]] && printf yes || printf no)" \
    'agent-run.sh stays at or under 1800 lines (issue #731 verification records)'
