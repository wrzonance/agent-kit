...
assert_eq yes "$([[ $(wc -l < "$root/agentkit/skills/.shared/scripts/agent-run.sh") -le 1859 ]] && printf yes || printf no)" \
    'agent-run.sh stays at or under 1859 lines (issue #732 typed failures)'
