...
assert_eq yes "$([[ $(wc -l < "$root/agentkit/skills/.shared/scripts/agent-run.sh") -le 1998 ]] && printf yes || printf no)" \
    'agent-run.sh stays at or under 1998 lines (#873 tested-head metadata)'
