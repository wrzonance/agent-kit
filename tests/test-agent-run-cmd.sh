...
assert_eq yes "$([[ $(wc -l < "$root/agentkit/skills/.shared/scripts/agent-run.sh") -le 2004 ]] && printf yes || printf no)" \
    'agent-run.sh stays at or under 2004 lines (#874 yielded-run lifecycle)'
