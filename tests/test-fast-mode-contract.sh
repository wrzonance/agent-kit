...
assert_eq yes "$([[ $(wc -c < "$root/agentkit/skills/parallel-issues/references/triage-and-selection.md") -le 39702 ]] && printf yes || printf no)" \
    'triage-and-selection reference stays at or under 39702 bytes'
