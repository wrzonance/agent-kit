...
assert_eq yes "$([[ $(wc -c < "$root/agentkit/skills/parallel-issues/references/triage-and-selection.md") -le 39858 ]] && printf yes || printf no)" \
    'triage-and-selection reference stays at or under 39858 bytes'
