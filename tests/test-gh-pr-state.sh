...
assert_eq yes "$([[ $(wc -l < "$root/agentkit/skills/review-remote-pr/scripts/gh-pr-state.sh") -le 1300 ]] && printf yes || printf no)" \
    'gh-pr-state.sh stays at or under 1300 lines'
