...
assert_eq yes "$([[ $(wc -l < "$root/agentkit/skills/parallel-issues/scripts/prepare-issue-artifacts.sh") -le 557 ]] && printf yes || printf no)" \
    'prepare-issue-artifacts.sh stays at or under 557 lines'
