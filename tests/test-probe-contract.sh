...
assert_eq yes "$([[ $(wc -l < "$root/agentkit/skills/review-remote-pr/scripts/claude-adversarial-review.sh") -le 700 ]] && printf yes || printf no)" \
    'claude-adversarial-review.sh stays at or under 700 lines'
