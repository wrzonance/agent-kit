...
assert_eq yes "$([[ $(wc -c < "$root/agentkit/skills/review-remote-pr/references/adversarial-review.md") -le 25823 ]] && printf yes || printf no)" \
    'adversarial-review reference stays at or under 25823 bytes'
