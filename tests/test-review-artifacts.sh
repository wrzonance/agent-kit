...
assert_eq yes "$([[ $(wc -c < "$root/agentkit/skills/review-remote-pr/references/adversarial-review.md") -le 31501 ]] && printf yes || printf no)" \
    'adversarial-review reference stays at or under 31501 bytes'
