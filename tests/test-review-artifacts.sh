...
assert_eq yes "$([[ $(wc -c < "$root/agentkit/skills/review-remote-pr/references/adversarial-review.md") -le 27755 ]] && printf yes || printf no)" \
    'adversarial-review reference stays at or under 27755 bytes'
