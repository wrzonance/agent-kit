...
assert_eq yes "$([[ $(wc -l < "$root/agentkit/skills/review-remote-pr/scripts/review-ledger.sh") -le 805 ]] && printf yes || printf no)" \
    'review-ledger.sh stays at or under 805 lines'
