...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 7823 tokens' 'the token ratchet names its ceiling'
...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 519 lines' 'the line ratchet names its ceiling'
