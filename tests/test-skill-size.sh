...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 9157 tokens' 'the token ratchet names its ceiling'
...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 500 lines' 'the line ratchet names its ceiling'
...
# The parallel-issues skill remains over the standard budget after extracting
# helper-owned recipes; keep the new measured ratchet explicit.
...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 790 lines' \
    'the parallel-issues line ratchet pins the extracted-recipe ceiling'
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 17021 tokens' \
