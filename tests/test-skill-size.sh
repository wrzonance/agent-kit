...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 9540 tokens' 'the token ratchet names its ceiling'
...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 778 lines' \
    'the parallel-issues line ratchet pins the extracted-recipe ceiling'
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 16773 tokens' \
