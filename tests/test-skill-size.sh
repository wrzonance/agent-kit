...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 9035 tokens' 'the token ratchet names its ceiling'
...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 496 lines' 'the line ratchet names its ceiling'
...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 18228 tokens' \
