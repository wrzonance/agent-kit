...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 7740 tokens' 'the token ratchet names its ceiling'
...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 446 lines' 'the line ratchet names its ceiling'
...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 933 lines' \
    'the parallel-issues line ratchet pins the stacked ceiling'
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 17796 tokens' \
