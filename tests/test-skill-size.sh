...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 9789 tokens' 'the token ratchet names its ceiling'
...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 854 lines' \
    'the parallel-issues line ratchet pins the extracted-recipe ceiling'
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 18483 tokens' \
