...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 7707 tokens' 'the token ratchet names its ceiling'
...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 17775 tokens' \
