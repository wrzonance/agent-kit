...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 8087 tokens' 'the token ratchet names its ceiling'
...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 461 lines' 'the line ratchet names its ceiling'
...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 18122 tokens' \
