...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 9701 tokens' 'the token ratchet names its ceiling'
...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 534 lines' 'the line ratchet names its ceiling'
...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 824 lines' \
    'the parallel-issues line ratchet pins the extracted-recipe ceiling'
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 17755 tokens' \
