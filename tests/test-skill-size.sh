...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 9180 tokens' 'the token ratchet names its ceiling'
...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 603 lines' 'the line ratchet names its ceiling'
