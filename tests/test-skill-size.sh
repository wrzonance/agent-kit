...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 9170 tokens' 'the token ratchet names its ceiling'
...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 17239 tokens' \
