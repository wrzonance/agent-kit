...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 7985 tokens' 'the token ratchet names its ceiling'
...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 459 lines' 'the line ratchet names its ceiling'
...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 18109 tokens' \
