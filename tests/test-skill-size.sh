...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 8652 tokens' 'the token ratchet names its ceiling'
...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 481 lines' 'the line ratchet names its ceiling'
...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 16169 tokens' \
