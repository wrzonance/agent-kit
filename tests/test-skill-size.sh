...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 7959 tokens' 'the token ratchet names its ceiling'
...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 1051 lines' \
    'the parallel-issues line ratchet pins the stacked ceiling'
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 17987 tokens' \
