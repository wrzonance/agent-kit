...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 9103 tokens' 'the token ratchet names its ceiling'
...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 599 lines' 'the line ratchet names its ceiling'
