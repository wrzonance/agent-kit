...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 8143 tokens' 'the token ratchet names its ceiling'
...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 511 lines' 'the line ratchet names its ceiling'
...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 1060 lines' \
    'the parallel-issues line ratchet pins the stacked ceiling'
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 18191 tokens' \
