...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 8167 tokens' 'the token ratchet names its ceiling'
...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 493 lines' 'the line ratchet names its ceiling'
...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 1002 lines' \
    'the parallel-issues line ratchet pins the stacked ceiling'
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 18581 tokens' \
