...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 9663 tokens' 'the token ratchet names its ceiling'
...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 532 lines' 'the line ratchet names its ceiling'
...
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 792 lines' \
    'the parallel-issues line ratchet pins the extracted-recipe ceiling'
assert_contains "$LINT_OUT" 'past its ratcheted ceiling of 17098 tokens' \
