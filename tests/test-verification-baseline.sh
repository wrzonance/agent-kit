...
assert_eq yes "$([[ $(wc -l < "$root/agentkit/skills/review-remote-pr/scripts/verification-baseline.sh") -le 339 ]] && printf yes || printf no)" \
    'verification-baseline.sh stays at or under 339 lines'
